...
def play(env, transpose=True, fps=200, zoom=None, callback=None, keys_to_action=None):
    ...
    Demo_gym.utils.play.PlayPlot. Here's a sample code for plotting the reward
