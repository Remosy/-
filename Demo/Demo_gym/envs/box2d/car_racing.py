...
import Demo_gym
from Demo_gym import spaces
from Demo_gym.envs.box2d.car_dynamics import Car
from Demo_gym.utils import colorize, seeding, EzPickle
...
#
# python Demo_gym/envs/box2d/car_racing.py
#
...
class CarRacing(Demo_gym.Env, EzPickle):
    metadata = {
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            from Demo_gym.envs.classic_control import rendering
...
if __name__=="__main__":
    ...
    record_video = False
    if record_video:
        from Demo_gym.wrappers.monitor import Monitor
