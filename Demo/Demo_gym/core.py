...
class Env(object):
    ...
    def unwrapped(self):
        ...
        Returns:
            gym.Env: The base non-wrapped Demo_gym.Env instance
        """
        return self
...
class GoalEnv(Env):
    ...
    def reset(self):
        ...
        if not isinstance(self.observation_space, Demo_gym.spaces.Dict):
            raise error.Error('GoalEnv requires an observation space of type Demo_gym.spaces.Dict')
